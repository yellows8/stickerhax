...
//ROPBUF: Probably varies per-region. Address of this savefile buffer in the heap.
...
.word 0 @ +0x20 u32: When updating the savefile the u32 from savefile+0x180 is copied to here. This is a bitmask with 5 bits, presumably for the stickers displayed on the save-select screen.
.word 0 @ +0x24, unknown.
...
.word 0 @ +0x30 u32: Counter. When updating the savefile, this is set to <highest counter value from all 3 savefiles> + 1.
